              ...
              {title === "Leads" && (
                <div className="relative shrink-0">
                  <button
                    ...
                    className="flex items-center justify-between gap-3 px-4 py-2 bg-slate-50 border border-slate-100 rounded-xl text-[10px] font-bold  tracking-widest text-[#18254D] hover:bg-white hover:border-slate-200 transition-all min-w-[160px] shadow-sm shadow-slate-200/50 group"
                  >
                    <span>
                      {leadTypeFilter === "All"
                        ? "All Lead Status"
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-6">
                          ...
                          <div className="min-w-0">
                            ...
                            <div className="text-[10px] text-slate-400 font-bold  tracking-widest truncate">
