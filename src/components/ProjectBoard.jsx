              ...
              <div className="relative shrink-0 w-full lg:w-auto">
                ...
                {isCategoryDropdownOpen && (
                  <>
                    ...
                    />
                    <div className="absolute top-full left-0 mt-2 min-w-[160px] w-full bg-white border border-slate-100 rounded-2xl shadow-2xl overflow-hidden z-[90] animate-fade-in origin-top">
