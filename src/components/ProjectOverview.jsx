    ...
    <div className="w-full h-full relative space-y-6">
      ...
      <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-sm flex items-center justify-between gap-5 animate-fade-in">
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-[#18254D] tracking-tight leading-none">
            {formData.name}
          </h2>
        </div>
        ...
        <div className="space-y-5">
          ...
          <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-sm group hover:border-success/30 transition-all animate-fade-in-right">
            ...
            {isEditing ? (
              ...
              <p className="text-3xl font-bold text-[#18254D] tracking-tight shrink-0">
                {formData.budget > 0
              ...
              <div className="space-y-2">
                ...
                {isEditing ? (
                  <input
                    ...
                    className="w-full px-4 py-2 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:border-secondary text-xs font-bold text-white"
                  />
                ) : (
